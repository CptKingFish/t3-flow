...
export default function ChartsMenu() {
  ...
  return (
    <div className="relative mt-6 flex-1 px-4 sm:px-6">
      <DeleteChartModal deleteModal={openDeleteChartModal} setDeleteModal={setOpenDeleteChartModal} chartId={currentChartId} refetch={refetchCharts} />
          ...
          ? charts.map((chart) => (
            <li key={chart.id}>
              ...
              >
                ...
                <button className="absolute right-3 opacity-1 group-hover:opacity-100 z-50" onClick={(event) => {
